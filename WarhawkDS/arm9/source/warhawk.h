...
#define FX_COLOR_PULSE				BIT(16)
#define FX_COPPER_TEXT				BIT(17)
#define FX_COLOR_CYCLE_TEXT			BIT(18)
#define FX_TEXT_SCROLLER			BIT(19)
#define FX_STARFIELD				BIT(20)
#define FX_PALETTE_FADE_TO_RED		BIT(21)
#define FX_STARFIELD_DOWN			BIT(22)
