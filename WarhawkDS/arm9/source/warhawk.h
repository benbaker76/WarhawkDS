...
#define FX_FADE_BG0_IN				BIT(5)
#define FX_FADE_BG0_OUT				BIT(6)
#define FX_MOSAIC_IN				BIT(7)
#define FX_MOSAIC_OUT				BIT(8)
#define FX_SPOTLIGHT_IN				BIT(9)
#define FX_SPOTLIGHT_OUT			BIT(10)
#define FX_SCANLINE					BIT(11)
#define FX_WIPE_IN_LEFT				BIT(12)
#define FX_WIPE_IN_RIGHT			BIT(13)
#define FX_WIPE_OUT_UP				BIT(14)
#define FX_WIPE_OUT_DOWN			BIT(15)
#define FX_CROSSWIPE				BIT(16)
#define FX_COLOR_CYCLE				BIT(17)
#define FX_COLOR_PULSE				BIT(18)
#define FX_COPPER_TEXT				BIT(19)
#define FX_COLOR_CYCLE_TEXT			BIT(20)
#define FX_TEXT_SCROLLER			BIT(21)
#define FX_STARFIELD				BIT(22)
#define FX_PALETTE_FADE_TO_RED		BIT(23)
#define FX_STARFIELD_DOWN			BIT(24)
#define FX_STARFIELD_MULTI			BIT(25)
#define FX_FIREWORKS				BIT(26)
