...
devoptab_t EFSdevoptab = {
    ...
    (void*)&EFS_Write,                 // int (*write_r)(struct _reent *r, int fd, const char *ptr, int len);
    (void*)&EFS_Read,                  // int (*read_r)(struct _reent *r, int fd,char *ptr, int len);
    (void*)&EFS_Seek,                  // int (*seek_r)(struct _reent *r, int fd, int pos, int dir);
